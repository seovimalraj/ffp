                ...
                <div className="px-8 py-8 max-w-4xl">
                  ...
                  {(() => {
                    try {
                      ...
                      const materialRecs = recommendOptimalMaterial(
                        geometry,
                        process,
                        undefined,
                      );
                      const manufacturabilityScore =
                        calculateManufacturabilityScore(
                          geometry,
                          localPart.material || "aluminum-6061",
                          process,
                        );
                      ...
                      const leadTimePrediction = predictLeadTime(
                        geometry,
                        process,
                        localPart.quantity || 1,
                        localPart.leadTimeType || "standard",
                      );
                        ...
                        <div className="mb-10">
                          <div className="grid lg:grid-cols-[240px_1fr] gap-8 items-start">
                            <div>
                              ...
                              <p className="text-sm text-gray-500 mt-1.5 leading-relaxed">
                                Intelligent insights based on your part geometry
                                and requirements.
                              </p>
                            </div>
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-5 shadow-sm">
                                <div className="flex items-center justify-between mb-3">
                                  ...
                                  <div
                                    className={`px-3 py-1 rounded-full text-xs font-bold ${
                                      manufacturabilityScore.grade === "A"
                                        ? "bg-green-500 text-white"
                                        : manufacturabilityScore.grade === "B"
                                          ? "bg-blue-500 text-white"
                                          : manufacturabilityScore.grade === "C"
                                            ? "bg-yellow-500 text-white"
                                            : manufacturabilityScore.grade ===
                                                "D"
                                ...
                                {manufacturabilityScore.suggestions.length >
                                  0 && (
                                  <div className="space-y-2 mt-3 pt-3 border-t border-blue-200">
                                    {manufacturabilityScore.suggestions.map(
                                      (suggestion, idx) => (
                                        <p
                                          key={idx}
                                    ...
                                    {materialRecs
                                      ...
                                      .map((rec, idx) => (
                                        ...
                                        >
                                          ...
                                          {rec.costImpact !== 0 && (
                                            <p
                                              className={`text-xs font-medium ${rec.costImpact < 0 ? "text-green-600" : "text-red-600"}`}
                                            >
                                              {rec.costImpact < 0
                                                ? "Saves"
                                                : "Adds"}{" "}
                                              $
                                              {Math.abs(rec.costImpact).toFixed(
                                                2,
                                              )}
                                            </p>
                                          )}
                              ...
                              <div className="bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-200 rounded-xl p-5 shadow-sm">
                                ...
                                <div className="space-y-2 mt-3 pt-3 border-t border-orange-200">
                                  {leadTimePrediction.breakdown.map(
                                    (phase, idx) => (
                                      <div
                                        key={idx}
                                ...
                                {leadTimePrediction.alternatives.length > 0 && (
                                  <div className="mt-3 pt-3 border-t border-orange-200">
                                    ...
                                    {leadTimePrediction.alternatives.map(
                                      (alt, idx) => (
                                        <div
                                          key={idx}
                                  ...
                                  return (
                                    <div className="bg-gradient-to-br from-teal-50 to-cyan-50 border border-teal-200 rounded-xl p-5 shadow-sm">
                                      ...
                                      <div className="grid grid-cols-2 gap-3 mb-3">
                                        <div className="bg-white rounded-lg p-3 border border-teal-100">
                                          ...
                                          <div className="text-lg font-bold text-teal-600">
                                            {nestingOpt.materialUtilization.toFixed(
                                              1,
                                            )}
                                            %
                                          </div>
                                      ...
                                      <div className="space-y-2 pt-3 border-t border-teal-200">
                                        {nestingOpt.recommendations.map(
                                          (rec, idx) => (
                                            <p
                                              key={idx}
                                              className="text-xs text-gray-700 flex items-start gap-2"
