...
// import CadViewer3D from "@/components/viewer/CadViewer3D";
import { getRFQ, getOrder, getBidsForRFQ } from "../../../../lib/database";
          ...
          <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-800">
                Your bid has been sent to the admin team for review. You'll be
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-800">
                  Customer identity and contact information are hidden for
                  privacy. All communication will be handled through the
                  platform.
                </p>
              </div>
            </div>
                  ...
                  {orderData?.parts?.map((part: any, index: number) => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Part {index + 1} of {orderData.parts.length}
                          </p>
                        </div>
                      ...
                      <div className="mt-4 pt-4 border-t">
                        {/*  <CadViewer3D
                          modelUrl={part.file_url || part.url || ""}
                          fileType={
                            (part.file_name
                              ?.split(".")
                              .pop()
                              ?.toLowerCase() as any) || "stl"
                          }
                          height="300px"
                        /> */}
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                          * Customer logos and identifiers are masked in
                          technical drawings
                        </p>
                      </div>
                    </div>
